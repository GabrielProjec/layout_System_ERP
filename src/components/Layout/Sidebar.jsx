...
const Sidebar = ({ isVisible, toggleSidebar }) => {
  ...
  return (
    <div
      className={`bg-[rgb(32,45,105)] dark:bg-[#292929]   ${
    ...
    >
      <RxPinLeft
        className={`bg-none text-white  text-2xl absolute right-2 top-4 cursor-pointer ${
          !open && "rotate-180"
        } `}
      ...
      <div>
          ...
          <div className="relative group">
            <Link to="/">
              ...
              >
                ...
                <span
                  className={` font-medium text-sm flex-1 duration-200   ${
                    !open && "hidden"
                  }`}
                >
                  Home
        ...
        {theme === "light" ? (
          <button className="flex  text-white" onClick={() => setTheme("dark")}>
            ...
            <span
              className={` font-medium text-sm flex-1 duration-200 text-white  ${
                !open && "hidden"
              }`}
            >
              Modo Dark
